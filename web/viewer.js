...
PDFJS.imageResourcesPath = '/Static/js/common/pdf.js/build/images/';
PDFJS.workerSrc = '/Static/js/common/pdf.js/build/pdf.worker.min.js';
PDFJS.cMapUrl = '/Static/js/common/pdf.js/web/cmaps/';
...
function webViewerLoad(file) {

    //如果是safari不允许range请求
    // if(navigator.userAgent.indexOf('Safari') != -1 && navigator.userAgent.indexOf('Chrome') == -1){
    //     Preferences.set('disableRange',true);
    //     Preferences.set('disableStream',true);
    // }
    
    PDFViewerApplication.initialize().then(function(){
        webViewerInitialized(file);
    });
}
...
function webViewerInitialized(file) {
    ...
    if (file) {
        PDFViewerApplication.open(file, 0,undefined,undefined,{
            //httpHeaders:{
